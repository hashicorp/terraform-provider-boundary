		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.boundary_scopes.foo", "items.0.%", "11"),
					resource.TestCheckResourceAttr("data.boundary_scopes.foo", "items.0.authorized_actions.#", "4"),
					resource.TestCheckResourceAttr("data.boundary_scopes.foo", "items.0.authorized_actions.0", "no-op"),
					resource.TestCheckResourceAttr("data.boundary_scopes.foo", "items.0.authorized_actions.1", "read"),
					resource.TestCheckResourceAttr("data.boundary_scopes.foo", "items.0.authorized_actions.2", "update"),
					resource.TestCheckResourceAttr("data.boundary_scopes.foo", "items.0.authorized_actions.3", "delete"),
