		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.boundary_targets.foo", "items.0.%", "24"),
					...
					resource.TestCheckResourceAttr("data.boundary_targets.foo", "items.0.egress_worker_filter", "type == \"foo\""),
